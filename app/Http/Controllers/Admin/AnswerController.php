...
class AnswerController extends Controller
{
    ...
    public function showAnswerQuestion($questionid)
    {
        ...
        ->get();
        $result['remark'] = \App\Models\AnswerRight::where('question_id',$questionid)->get();
        return json_encode($result);
    }
    ...
    public function Lists(){
        ...
        ->addColumn('action',function($rec){
            $str='
                ...
                <button  class="btn btn-xs btn-danger btn-condensed btn-delete btn-tooltip" data-id="'.$rec->answer_id.'" data-rel="tooltip" title="ลบ">
